    ...
    <div>
      <div className={styles.main}>
        <div className={styles.up}>
          <a target="_blank" href="https://www.instagram.com/luka3bilic/">
          ...
          <a target="_blank" href="https://test-kbr4105.slack.com/team/U06SR4U2EA0">
        ...
        <div className={styles.down}>
          <a target="_blank" href="https://github.com/LukaBilic2">
          ...
          <a
            target="_blank"
            href="https://discordapp.com/users/262992013086031882"
          >
